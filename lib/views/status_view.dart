...
class _StatusViewState extends State<StatusView> {
  ...
  TextEditingController userNameStatusEditingController = new TextEditingController();
  String _status;
  @override
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(left: MediaQuery.of(context).size.width*0.5, top: 15),
              child: GestureDetector(
                  onTap: (){
                    print(userNameStatusEditingController.text);
                    methods.changeUserStatus(userNameStatusEditingController.text);
